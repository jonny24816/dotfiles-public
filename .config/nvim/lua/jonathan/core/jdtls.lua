local function get_jdtls()
    -- get mason registry to access binaries
    local mason_registry = require("mason-registry")
    -- jdtls package
    local jdtls = mason_registry.get_package("jdtls")
    -- path for jdtls binaries
    ...
    local config = jdtls_path .. "/config_" .. SYSTEM -- OS specific config
...
local function setup_jdtls()
    ...
    local root_dir = jdtls.setup.find_root({ '.git', 'mvnw', 'gradlew', 'build.gradle' });
